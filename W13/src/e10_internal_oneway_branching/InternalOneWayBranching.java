package e10_internal_oneway_branching;
...
//Eleanor Ezimah
public class InternalOneWayBranching {

    @SuppressWarnings("unchecked")
    public class TrieNoInternalOneWayBranching<Value>
            extends ExternalOneWayBranching.TrieNoExternalOneWayBranching<Value> {
    ...
    public class TernarySearchTrieNoInternalOneWayBranching<Value>
            extends ExternalOneWayBranching.TernarySearchTrieNoExternalOneWayBranching<Value> {
    ...
    public static void main(String[] args) {
        InternalOneWayBranching internalOneWayBranching = new InternalOneWayBranching();
    ...
    private void tstTests() {
    	StdOut.println("\nAuthor - Eleanor Ezimah");
        StdOut.println("Ternary Search Trie tests");
        StdOut.println();
